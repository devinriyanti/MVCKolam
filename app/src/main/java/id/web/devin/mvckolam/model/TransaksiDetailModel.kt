...
class TransaksiDetailModel(private val context: Context) {
    interface TransaksiDetailCallback {
        fun onTransaksiDetailLoaded(transaksiDetailList: List<Transaction>)
    ...
    fun fetchTransaksiDetail(email:String, status:String, idtransaksi: String, callback: TransaksiDetailCallback) {
        ...
        val stringReq = object : StringRequest(
            ...
            { response ->
                ...
                callback.onTransaksiDetailLoaded(transaksi)
            },
            { error ->
    ...
    fun fetchTransaksiAdminDetail(email:String, status:String, idtransaksi: String, callback: TransaksiDetailCallback) {
        queue = Volley.newRequestQueue(context)
    ...
    private fun parseTransaksi(response: String?,callback: TransaksiDetailCallback): List<Transaction> {
