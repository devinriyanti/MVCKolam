...
import id.web.devin.mvckolam.controller.*
...
import id.web.devin.mvvmkolam.view.CheckoutItemAdapter

class CheckoutFragment : Fragment(), ProfilView,CartDetailView,TransaksiView, ShippingView {
    private lateinit var b:FragmentCheckoutBinding
    private lateinit var cPengguna:ProfileController
    private lateinit var cCartDetail:CartDetailController
    ...
    override fun onCreateView(
        ...
        cCartDetail = CartDetailController(this.requireContext(), this)
    ...
    override fun showProfil(profileData: List<Pengguna>) {
        profileData.forEach {
