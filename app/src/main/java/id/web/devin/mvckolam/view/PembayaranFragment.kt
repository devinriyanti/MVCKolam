...
import id.web.devin.mvckolam.databinding.FragmentPembayaranBinding
...
class PembayaranFragment : Fragment(),KolamDetailView,ProfilView,TransaksiView, UploadView {
    private lateinit var b:FragmentPembayaranBinding
    private lateinit var cKolam:KolamDetailController
    ...
    override fun onCreateView(
        ...
        cKolam = KolamDetailController(this.requireContext(),this)
