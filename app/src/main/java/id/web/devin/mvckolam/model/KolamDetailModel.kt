...
class KolamDetailModel(private val context: Context) {
    interface KolamDetailCallback {
        fun onKolamDetailLoaded(kolamDetailList: List<Kolam>)
    ...
    fun fetchDetailKolam(idKolam:String,callback: KolamDetailCallback){
        ...
        val stringReq = StringRequest(Request.Method.GET,url,
            {response->
                ...
                callback.onKolamDetailLoaded(kolam)
            },
            {error->
    ...
    private fun parseKolam(response: String?,callback: KolamDetailCallback): List<Kolam> {
        ...
        try {
            ...
            callback.onError("Error parsing products")
        }
        return kolams
    }
