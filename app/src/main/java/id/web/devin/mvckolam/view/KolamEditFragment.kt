...
import id.web.devin.mvckolam.databinding.FragmentKolamEditBinding
...
class KolamEditFragment : Fragment(), KolamView, KolamDetailView {
    private lateinit var b: FragmentKolamEditBinding
    private lateinit var cKolam:KolamController
    private lateinit var cKolamDetai:KolamDetailController
    ...
    override fun onCreateView(
        ...
        cKolamDetai = KolamDetailController(this.requireContext(),this)
